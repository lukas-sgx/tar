...
// +kubebuilder:rbac:groups=gdr.soigneux.works,resources=microservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gdr.soigneux.works,resources=microservices/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=gdr.soigneux.works,resources=microservices/finalizers,verbs=update
